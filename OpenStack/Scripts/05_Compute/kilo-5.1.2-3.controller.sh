...
func_nova_install_package_controller_node
# (2-2) Edit the /etc/nova/nova.conf file and complete the following actions:
# (2-3) To finalize installation

func_nova_configure_controller_node

# (3) To finalize installation
func_nova_start_service_controller_node

func_nova_remove_sqllite_ubuntu_controller_node
