...
func_neutron_configure_prerequisites_compute_node

func_neutron_install_package_compute_node

func_neutron_configure_compute_node

func_neutron_start_service_compute_node
