...
func_swift_configure_prerequisites_object_node ${INSTANCE_MANAGEMENT_INTERFACE_IP_ADDRESS_OBJECT2}
...
func_swift_configure_object_node ${INSTANCE_MANAGEMENT_INTERFACE_IP_ADDRESS_OBJECT2}
