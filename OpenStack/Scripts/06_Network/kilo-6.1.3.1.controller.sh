...
func_common_database_create_grant neutron ${NEUTRON_DBPASS}
...
func_common_create_user_role neutron ${NEUTRON_PASS} admin service

# func_common_create_service_and_endpoint [name]  [description] [server-name] [publicurl] [internalurl] [adminurl]
func_common_create_service_and_endpoint neutron  "OpenStack Networking" network http://controller:9696 http://controller:9696 http://controller:9696
